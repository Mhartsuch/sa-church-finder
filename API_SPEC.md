...
#### `POST /churches` *(site_admin only)*
Create a new church listing.

---

#### `PATCH /churches/:id` *(church_admin or site_admin)*
...
#### `POST /churches/:churchId/services` *(church_admin)*
...
#### `PATCH /churches/services/:id` *(church_admin)*
Update an existing service.

---

#### `DELETE /churches/services/:id` *(church_admin or site_admin)*
Remove a service.
...
#### `POST /churches/:churchId/photos` *(church_admin)*
...
#### `PATCH /churches/photos/:id` *(church_admin)*
Update photo metadata (alt_text, display_order).

---

#### `DELETE /churches/photos/:id` *(church_admin or site_admin)*
...
#### `POST /churches/:churchId/reviews` *(authenticated)*
Create a review.
...
#### `DELETE /reviews/:id` *(review owner or site_admin)*
Delete a review.
...
#### `POST /reviews/:id/flag` *(authenticated)*
...
#### `POST /churches/:churchId/events` *(church_admin)*
Create an event.

---

#### `PATCH /events/:id` *(church_admin)*
Update an event.

---

#### `DELETE /events/:id` *(church_admin or site_admin)*
Delete an event.
...
#### `GET /users/:id/saved`
Get user's saved churches. *(authenticated, own profile only)*

---

#### `POST /churches/:id/save` *(authenticated)*
...
#### `GET /admin/claims` *(site_admin)*
List pending church claim requests.

---

#### `PATCH /admin/claims/:id` *(site_admin)*
...
#### `GET /admin/flagged-reviews` *(site_admin)*
...
#### `POST /churches/:id/claim` *(authenticated)*
