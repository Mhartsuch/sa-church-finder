...
Follow conventions in CONVENTIONS.md strictly.
Check DECISIONS.md before making any architectural choices.
...
- Never modify the database schema without updating DATA_MODELS.md
