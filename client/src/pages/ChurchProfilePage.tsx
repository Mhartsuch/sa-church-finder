  ...
  return (
    <div className='flex-1 overflow-y-auto bg-white'>
      ...
      <div className='mx-auto max-w-[1120px] px-6 pb-16 lg:px-0'>
        <div className='flex flex-col gap-12 lg:flex-row lg:gap-24'>
              ...
              <div className='border-b border-gray-200 py-8'>
                ...
                <div className='space-y-5'>
                  {groupedServices.map(({ day, dayName, services }) => (
                    <div key={day}>
                      <h3 className='mb-2 text-[16px] font-semibold text-[#222222]'>
                        {dayName}
                      </h3>
          ...
          <div className='w-full flex-shrink-0 lg:w-[370px]'>
            <div className='sticky top-[96px] rounded-xl border border-gray-200 p-6 shadow-airbnb'>
      ...
      <footer className='border-t border-gray-200 bg-[#f7f7f7]'>
        <div className='mx-auto max-w-[1120px] px-6 py-6 lg:px-0'>
