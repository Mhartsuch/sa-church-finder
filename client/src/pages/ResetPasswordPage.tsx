    ...
    >
      <div className='space-y-3'>
        ...
        <p className='text-sm leading-6 text-[#555555]'>
          You&apos;ll use this new password the next time you sign in. The reset
          does not automatically log you into the app.
        </p>
      </div>
      ...
      {!token ? (
        <div className='mt-8 space-y-4'>
          <div className='rounded-[28px] border border-[#ffb4c1] bg-[#fff1f4] p-5 text-sm leading-6 text-[#9f1239]'>
            This password reset link is incomplete or malformed. Request a new
            link to keep going.
          </div>
        ...
        <div className='mt-8 space-y-4'>
          <div className='rounded-[28px] border border-[#b7ebcd] bg-[#f2fbf6] p-5 text-sm leading-6 text-[#1f5132]'>
            Your password has been updated. Head back to sign in with the new
