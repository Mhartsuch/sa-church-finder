    ...
    >
      <div className='space-y-3'>
        ...
        <p className='text-sm leading-6 text-[#555555]'>
          Once this succeeds, your account badge and future auth flows will reflect
          that the address has been confirmed.
        </p>
      </div>

      {!token ? (
        <div className='mt-8 space-y-4'>
          <div className='rounded-[28px] border border-[#ffb4c1] bg-[#fff1f4] p-5 text-sm leading-6 text-[#9f1239]'>
            This verification link is incomplete or malformed. Request a fresh
            link from your account area and try again.
          </div>

          <Link
            to={fallbackPath}
            className='inline-flex rounded-full bg-[#222222] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-black'
          >
            {fallbackLabel}
          </Link>
        </div>
      ) : verifyEmailMutation.isPending ? (
        <div className='mt-8 rounded-[28px] border border-gray-200 bg-[#fcfbf8] p-5 text-sm leading-6 text-[#555555]'>
        ...
        <div className='mt-8 space-y-4'>
          ...
          <Link
            ...
            className='inline-flex rounded-full bg-[#FF385C] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-[#E00B41]'
          >
