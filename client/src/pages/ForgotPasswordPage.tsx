    ...
    >
      <div className='space-y-3'>
        ...
        <p className='text-sm leading-6 text-[#555555]'>
          Enter the email on your account and we&apos;ll start the reset flow. For
          security, the success message stays the same whether or not that email is
          registered.
        </p>
      </div>
      ...
      {successState ? (
        <div className='mt-8 space-y-4'>
          ...
          <button
            ...
            className='rounded-full border border-gray-300 px-5 py-3 text-sm font-semibold text-[#222222] transition-colors hover:bg-gray-50'
          >
            Send another link
          </button>
        </div>
