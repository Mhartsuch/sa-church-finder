...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[#e8e4de] bg-white/95 backdrop-blur-md">
      <div className="mx-auto max-w-[1760px] px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="flex min-h-[80px] items-center gap-4">
          <Link to="/" className="flex flex-shrink-0 items-center gap-2 text-[#d90b45]">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            ...
            <button
              ...
              className="hidden rounded-full px-3 py-2 text-sm font-semibold text-[#1a1a1a] transition-colors hover:bg-[#f5f2ed] xl:inline-flex"
            >
              List your church
            </button>
            ...
            <Link
              to={wishlistHref}
              className="hidden items-center gap-1 rounded-full px-3 py-2 text-sm font-semibold text-[#1a1a1a] transition-colors hover:bg-[#f5f2ed] md:inline-flex"
            >
            ...
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-full text-[#1a1a1a] transition-colors hover:bg-[#f5f2ed]"
              aria-label={
            ...
            <Link
              to="/search"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#e0ddd8] text-[#1a1a1a] transition-colors hover:border-[#1a1a1a] hover:bg-[#f5f2ed] lg:hidden"
            ...
            <Link
              to={menuHref}
              className="flex items-center gap-2.5 rounded-full border border-[#e0ddd8] bg-white px-3 py-2 transition-shadow hover:shadow-airbnb-subtle"
              aria-label={
                isLoading
            ...
            >
              ...
              <div className="flex h-[30px] min-w-[30px] items-center justify-center rounded-full bg-[#6b6560] px-2 text-xs font-semibold text-white">
