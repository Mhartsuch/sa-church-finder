      ...
      <div className="mx-auto max-w-[1760px] px-4 sm:px-6 lg:px-10 xl:px-12">
        <div className="flex min-h-[80px] items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-2 sm:gap-3">
            <Link
              to="/compare"
              className="relative inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#ddd] text-[#222] transition-colors hover:border-[#222] hover:bg-[#f7f7f7]"
              aria-label={
                compareCount > 0
            ...
            >
              ...
              {compareCount > 0 ? (
                <span className="absolute -right-1 -top-1 inline-flex h-5 min-w-[20px] items-center justify-center rounded-full bg-[#222] px-1 text-[10px] font-bold text-white">
                  {compareCount}
                </span>
              ) : null}
            </Link>
            ...
            <button
              ...
              className="hidden rounded-full px-3 py-2 text-sm font-semibold text-[#222] transition-colors hover:bg-[#f7f7f7] xl:inline-flex"
            >
              List your church
            </button>
            ...
            <Link
              to={wishlistHref}
              className="hidden items-center gap-1 rounded-full px-3 py-2 text-sm font-semibold text-[#222] transition-colors hover:bg-[#f7f7f7] md:inline-flex"
            >
            ...
            <button
              ...
              className="inline-flex h-9 w-9 items-center justify-center rounded-full text-[#222] transition-colors hover:bg-[#f7f7f7]"
              aria-label={
            ...
            <Link
              to="/search"
              className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[#ddd] text-[#222] transition-colors hover:border-[#222] hover:bg-[#f7f7f7] lg:hidden"
            ...
            <Link
              to={menuHref}
              className="flex items-center gap-2.5 rounded-full border border-[#ddd] bg-white px-3 py-2 transition-shadow hover:shadow-airbnb-subtle"
              aria-label={
                isLoading
            ...
            >
              <Menu className="h-4 w-4 text-[#222]" />
