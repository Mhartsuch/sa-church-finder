...
export const RequireAuth = ({ children }: RequireAuthProps) => {
  ...
  if (isLoading) {
    return (
      <div className="flex flex-1 items-center justify-center bg-[#faf8f5] px-4 py-16">
      ...
      <div className="flex flex-1 items-center justify-center bg-[#faf8f5] px-4 py-16">
        <div className="max-w-md rounded-[28px] border border-gray-200 bg-white p-8 text-center shadow-airbnb-subtle">
          ...
          <button
            ...
            className="mt-6 rounded-full bg-[#1a1a1a] px-5 py-3 text-sm font-semibold text-white transition-colors hover:bg-black"
          >
            Try again
          </button>
        </div>
